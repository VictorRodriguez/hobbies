...
FOLDER="gcc"
URL="https://gitlab.com/x86-gcc/gcc/-/archive/users/intel/amx/master/gcc-users-intel-amx-master.tar.gz"

if [ ! -d "$FOLDER" ] ; then
    wget $URL
	tar -xvf gcc-users-intel-amx-master.tar.gz
	mv gcc-users-intel-amx-master $FOLDER
fi
