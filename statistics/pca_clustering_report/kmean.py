...
workload_name_df = pd.read_csv("pca.csv", usecols =['workload_name'])
workload_name = workload_name_df['workload_name'].values
...
grouped_lists = grouped_df["workload_name"].apply(list)
grouped_lists = grouped_lists.reset_index()
print(grouped_lists.explode('workload_name'))
